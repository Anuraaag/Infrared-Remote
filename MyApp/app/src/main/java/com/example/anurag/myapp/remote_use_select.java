...
public class remote_use_select extends AppCompatActivity {

    DatabaseHelper dh;
    @Override
    protected void onStart() {
        Toast.makeText(this, "remote_use_select", Toast.LENGTH_SHORT).show();
        super.onStart();
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.remote_use_select);
        ...
        sItems.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(remote_use_select.this, android.R.layout.simple_spinner_item, spinnerArray1);
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent( remote_use_select.this , remote_use.class);
